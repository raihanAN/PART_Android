...
public class DialogForm2 extends DialogFragment {
    ...
    public DialogForm2(String name, String age, String price, String skill, String doms, String desc, String key, String pilih) {
        this.name = name;
        this.age = age;
        this.price = price;
        this.skill = skill;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view= inflater.inflate(R.layout.inputprt,container,false);
        nama=view.findViewById(R.id.NamaPRT);
        umur=view.findViewById(R.id.UsiaPRT);
        gaji=view.findViewById(R.id.PaydayPRT);
        skillk=view.findViewById(R.id.SkillPRT);
        domisili=view.findViewById(R.id.DomisiliPRT);
        descript=view.findViewById(R.id.DescriprionPRT);
        nama.setText(name);
        umur.setText(age);
        gaji.setText(price);
        skillk.setText(skill);
        domisili.setText(doms);
        descript.setText(desc);
        btn=view.findViewById(R.id.Adding2);
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(asma)) {
                    ...
                    if (pilih.equals("Tambah")){
                        db.child("PRT").push().setValue(new PRT(asma, usia, payoff, power, domisili2, desc)).addOnSuccessListener(
                        ...
                        db.child("PRT").child(key).setValue(new PRT(asma, usia, payoff, power, domisili2, desc)).addOnSuccessListener(
                                new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
